...
var ASM_CONSTS = {
  6470864: function() {return Module.webglContextAttributes.premultipliedAlpha;},  
 6470925: function() {return Module.webglContextAttributes.preserveDrawingBuffer;},  
 6470989: function() {return Module.webglContextAttributes.powerPreference;},  
 6471047: function() {Module['emscripten_get_now_backup'] = performance.now;},  
 6471102: function($0) {performance.now = function() { return $0; };},  
 6471150: function($0) {performance.now = function() { return $0; };},  
 6471198: function() {performance.now = Module['emscripten_get_now_backup'];}
};
  ...
  function _GetTelegramUserData() {
      return allocateUTF8(getTelegramUserData());
    }
